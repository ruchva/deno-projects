...
class Pokemon {
    ...
    clone(): Pokemon {
      ...
      return new Pokemon(this.name, this.type, this.level, [...this.attacks]); // Clonar el arreglo de ataques
      // Completar: Crear un nuevo Pokémon con los mismos atributos pero sin clonar el arreglo de ataques.
      // return new Pokemon(this.name, this.type, this.level, this.attacks); // No clonar el arreglo de ataques.
      // Completar: Crear un nuevo Pokémon con los mismos atributos pero sin clonar el arreglo de ataques.
      // return new Pokemon(this.name, this.type, this.level, [...this.attacks]); // No clonar el arreglo de ataques.
    }
  ...
  function main() {
    ...
    console.log('%cBASEPokemon',COLORS.green);
    basePokemon.displayInfo();
    console.log('%cCLONE',COLORS.blue);
    clone1.displayInfo();
  }
