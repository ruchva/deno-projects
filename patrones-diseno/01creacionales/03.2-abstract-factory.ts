...
class GasCar {
    ...
    assemble(): void {
        console.log('Ensamblando un %cauto de combustión', COLORS.green);
    }
}
...
class ElectricEngine {
    ...
    start(): void {
        console.log('Arrancando %cmotor eléctrico', COLORS.blue);
    }
}
...
class GasEngine {
    ...
    start(): void {
        console.log('Arrancando %cmotor de combustión', COLORS.blue);
    }
}
